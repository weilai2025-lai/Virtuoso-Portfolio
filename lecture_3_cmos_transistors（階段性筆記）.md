...
### 24.6 從 I = Q / t 重新思考：為什麼 Square-Law 會失效？

在推導速度飽和之前，我們先**刻意回到最原始的電流定義**，  
因為只有這樣，後面的修正才會「有來有回」，而不是硬套模型。

---

#### 24.6.1 電流的最原始定義（我們一直沒有變過）
...
#### 24.6.3 Square-Law 模型到底假設了什麼？

在你前面完整推導的 square-law 中，我們做了兩個假設：
...
#### 24.8.1 回顧：Long-Channel Square-Law 的完整邏輯鏈
...
#### 24.8.7 由「線性區 = 飽和區」聯立解出新的 $V_{dsat}$ 
...
$$
\boxed{ V_{dsat} = \frac{(V_{gs} - V_t) \cdot V_c}{V_{gs} - V_t + V_c} }
$$
...
#### 24.8.9 與 Square-Law 的連續性檢查（重要直覺）
